...
This project is indexed by GitNexus as **ai-token-saver** (1144 symbols, 2185 relationships, 95 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
