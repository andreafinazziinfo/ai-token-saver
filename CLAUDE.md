...
This project is indexed by GitNexus as **ai-token-saver** (1429 symbols, 2749 relationships, 120 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
